...
def sequential_matrix_multiplication(A, B): 
    ...
    p1 = multiprocessing.Process(target=worker, args=(cols_B,cols_A,A,B,0,mid2,q))
    p2 = multiprocessing.Process(target=worker, args=(cols_B,cols_A,A,B,mid2,mid,q))
    p3 = multiprocessing.Process(target=worker, args=(cols_B,cols_A,A,B,mid,mid+mid2,q))
    p4 = multiprocessing.Process(target=worker, args=(cols_B,cols_A,A,B,mid2+mid,rows_A,q))
